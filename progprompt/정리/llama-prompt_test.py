...
# Load model
def load_llama_model(model_name="meta-llama/Llama-2-7b-hf", device="cuda" if torch.cuda.is_available() else "cpu"):
...
def planner_executer(args):
    ...
    tokenizer, model, device = load_llama_model(model_name=args.llama_model)
